    ...
    if (true) {
      (function() {
        ...
        function hasValidRef(config) {
          {
            if (hasOwnProperty11.call(config, "ref")) {
        ...
        function createElement(type, config, children) {
          ...
          if (config != null) {
            ...
            for (propName in config) {
              if (hasOwnProperty11.call(config, propName) && !RESERVED_PROPS.hasOwnProperty(propName)) {
    ...
    if (true) {
      (function() {
        ...
        function isAttributeNameSafe(attributeName) {
          if (hasOwnProperty11.call(validatedAttributeNameCache, attributeName)) {
            return true;
          }
          if (hasOwnProperty11.call(illegalAttributeNameCache, attributeName)) {
            return false;
          }
...
// esbuild-css-modules-plugin-namespace:/var/folders/ft/9v8l3d9x1ks3pv14ygr6qrz80000gn/T/tmp-30458-Qs6G4b3bY2Zb/react-form5/lib/Button/Button.module.css.js
init_react_shim();
...
button[variant="cta"][appearance="affirming"] {
	background-color: var(--colour-success);
}
button[variant="cta"][appearance="basic"] {
	background-color: var(--colour-light);
	border-color: var(--colour-medium);
	color: var(--colour-text-deemphasised);
	fill: var(--colour-text-deemphasised);
}
button[variant="cta"][appearance="danger"] {
	background-color: var(--colour-danger);
}
button[variant="cta"][appearance="primary"] {
	background-color: var(--colour-primary);
}
button[variant="cta"][appearance="warning"] {
	background-color: var(--colour-warning);
}
button[variant="cta"] > i[role="img"] {
	font-size: 2em;
}

button[variant="glyph"] {
...
var Button = ({
  ...
  ...others,
  className: (0, import_classnames.default)(Button_module_css_default.Button, className, {
...
Button.Group = ({ className, ...props }) => /* @__PURE__ */ React.createElement(Group, {
...
// esbuild-css-modules-plugin-namespace:/var/folders/ft/9v8l3d9x1ks3pv14ygr6qrz80000gn/T/tmp-30458-Qs6G4b3bY2Zb/react-form5/lib/FileInput/FileInput.module.css.js
init_react_shim();
...
var FileInput = class extends import_react.PureComponent {
  ...
  render() {
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, !!previews.length && /* @__PURE__ */ React.createElement("div", {
      className: FileInput_module_css_default.FileInputPreviews
    }, map_default(previews, ({
      file: { name: name2 },
      preview
    }) => {
      if (preview)
...
__publicField(FileInput, "defaultProps", {
  icon: /* @__PURE__ */ React.createElement("span", null, "\u{1F4C2}"),
  label: "Select file(s)",
  multiple: false,
  onChange: () => {
  }
...
// esbuild-css-modules-plugin-namespace:/var/folders/ft/9v8l3d9x1ks3pv14ygr6qrz80000gn/T/tmp-30458-Qs6G4b3bY2Zb/react-form5/lib/Input/Input.module.css.js
init_react_shim();
var digest3 = "0c8f151df2fc3007ab3166c44d6b5f201323f37a64e918d942f848b4e106c8a7";
...
var Input = ({
  ...
  return /* @__PURE__ */ React.createElement("div", {
    arrangement,
    className: (0, import_classnames3.default)(Input_module_css_default.InputField, {
    ...
    htmlFor: id
  }, label), !!error && /* @__PURE__ */ React.createElement("dialog", {
    className: Input_module_css_default.Error,
    open: true
  }, error), !!options?.size && /* @__PURE__ */ React.createElement("datalist", {
    id: others.list
  }, map_default(options, ({ name: name2 }, key) => /* @__PURE__ */ React.createElement("option", {
    key,
    value: key
  }, name2))));
};
...
function composeData(values, {
  ...
  if (tag && name) {
    if (tag === "fieldset") {
      ...
      const nestedFields = form.splice(i + 1, nestedFieldCount, ...Array(nestedFieldCount).fill({ tagName: "NESTED_FIELD" }));
      values[name] = reduce_default(nestedFields, composeData, Object.create(null));
...
// lib/deepDiff.js
function deepDiff(oldVals, newVals, delta = Object.create(null)) {
...
// esbuild-css-modules-plugin-namespace:/var/folders/ft/9v8l3d9x1ks3pv14ygr6qrz80000gn/T/tmp-30458-Qs6G4b3bY2Zb/react-form5/lib/Form.module.css.js
init_react_shim();
var digest4 = "966a6ecfd8b8723a391fb06eeec5a3bc67b5a7108b7c3070937017b29119906a";
...
var Form = class extends import_react3.PureComponent {
  ...
  setRef = (el) => {
    if (!el)
      return;
    this.initValues = reduce_default([...el.elements], composeData, this.initValues);
  };
  handleSubmit = (event, initValues, cb) => {
    ...
    if (!event.target.reportValidity())
      return;
    event.stopPropagation();
    const values = reduce_default([...event.target.elements], composeData, Object.create(null));
...
// esbuild-css-modules-plugin-namespace:/var/folders/ft/9v8l3d9x1ks3pv14ygr6qrz80000gn/T/tmp-30458-Qs6G4b3bY2Zb/react-form5/docs/Demo.module.css.js
init_react_shim();
...
function TestForm() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("section", {
  ...
  }, delta && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("header", {
    className: Demo_module_css_default.DataHeading
  }, "Delta"), /* @__PURE__ */ React.createElement("output", {
    className: Demo_module_css_default.Data
  }, JSON.stringify(delta, null, 2))), delta && values && /* @__PURE__ */ React.createElement("br", null), values && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("header", {
    className: Demo_module_css_default.DataHeading
  }, "Current values"), /* @__PURE__ */ React.createElement("output", {
    className: Demo_module_css_default.Data
  }, JSON.stringify(values, null, 2)))), /* @__PURE__ */ React.createElement(Form, {
    className: Demo_module_css_default.Column,
    name: "test",
    onSubmit: (d, v) => setData({ delta: d, values: v })
  }, /* @__PURE__ */ React.createElement(Button_default, {
    type: "submit"
  }, "Submit"), /* @__PURE__ */ React.createElement(Input_default, {
    defaultValue: "Jacob",
    label: "forename",
    name: "forename",
    type: "text"
    ...
    name: "togglable",
    type: "checkbox",
    variant: Input_default.VARIANTS.TOGGLE
  }), /* @__PURE__ */ React.createElement(Input_default, {
    checked: true,
    label: "read-only",
    name: "readonly",
...
(0, import_react_dom.render)(/* @__PURE__ */ React.createElement(TestForm, null), document.getElementById("app"));
/*
object-assign
(c) Sindre Sorhus
@license MIT
